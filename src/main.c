...
////////////////////////////////////////////////////////////////////////
// Function that receives a 3D vector and reutrns a projected 2D point
////////////////////////////////////////////////////////////////////////
...
void update(void) 
{
    ...
    for(int i = 0; i < num_faces; i++)
    {
        ...
        if (cull_method == CULL_BACKFACE)
        {
            ...
            // Compute the face nromal (using cross producct to find perpendicular)
        ...
        // Calculate the average depth of each face based on the vertices after transformation
